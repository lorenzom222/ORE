...
IMAGES_DIR="/home/lorenzo/ore-dir/swav/data/experiments/drive/final_data/home/nina/asian_skew_dataset"
...
EXPT_NAME=MobNet_ORE_ASIAN_MINI
EXPT_PATH="./experiments/MobNet_Large_Wider_ore_asian_finetuned_BALANCED"
mkdir -p $EXPT_PATH
GPU=0,1,2,3
