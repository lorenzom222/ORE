...
# Added --full_folder
CUDA_VISIBLE_DEVICES=${GPU} python eval_linear_mobilenet_INat.py --epochs 1 --ckpt_path /home/lorenzo/ore-dir/swav/experiments/INat_balanced_flip_crop_sl/checkpoint.pth.tar --num_classes 6 --pretrain_classes 270 --full_folder $IMAGES_DIR --wandb False --batch_size 64 --track_supcat_acc True
