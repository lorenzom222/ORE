...
EXPT_NAME=EVAL_ResNet_ORE_CAUCASIAN_512
EXPT_PATH="./experiments/$EXPT_NAME"
mkdir -p $EXPT_PATH
GPU=2
CKPT="/home/lorenzo/ore-dir/swav/resnet/ResNet_ORE_CAUCASIAN_PRETRAIN_512/checkpoint.pth.tar"
